...
MAIN_READDLE_LIB_DIR="Dependencies/ReaddleLib"
assert s7 add --stage "$MAIN_READDLE_LIB_DIR" '"$S7_ROOT/github/ReaddleLib"'
...
git checkout main
assert test $(xattr -p $STILL_ALIVE_ATTRIBUTE "$MAIN_READDLE_LIB_DIR") = $STILL_ALIVE_VALUE
